//
//  IOReportBridging.swift
//  DynamicIsland
//
//  Lightweight runtime loader for private IOReport symbols used by the GPU/CPU collectors.
//  Avoids static linking against the private framework by resolving symbols via dlopen/dlsym.
//
